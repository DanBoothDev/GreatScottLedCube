...
int REDLEDs[]={AaR,BaR,CaR,DaR,EaR,FaR,GaR,HaR,IaR,JaR,KaR,LaR,MaR,NaR,OaR,PaR,
...
int GREENLEDs[]={AaG,BaG,CaG,DaG,EaG,FaG,GaG,HaG,IaG,JaG,KaG,LaG,MaG,NaG,OaG,PaG,
...
int BLUELEDs[]={AaB,BaB,CaB,DaB,EaB,FaB,BaB,HaB,IaB,JaB,KaB,LaB,MaB,NaB,OaB,PaB,
